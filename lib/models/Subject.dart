...
class Subject extends amplify_core.Model {
  ...
  const Subject._internal({required this.id, required name, color, required userID, topics, createdAt, updatedAt}): _name = name, _color = color, _userID = userID, _topics = topics, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Subject({String? id, required String name, String? color, required String userID, List<Topic>? topics}) {
    return Subject._internal(
      id: id == null ? amplify_core.UUID.getUUID() : id,
      name: name,
      color: color,
      userID: userID,
      topics: topics != null ? List<Topic>.unmodifiable(topics) : topics);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is Subject &&
      ...
      DeepCollectionEquality().equals(_topics, other._topics);
  }
  ...
  Subject copyWith({String? name, String? color, String? userID, List<Topic>? topics}) {
    return Subject._internal(
      id: id,
      name: name ?? this.name,
  ...
  Subject copyWithModelFieldValues({
    ...
    ModelFieldValue<List<Topic>?>? topics
  }) {
    return Subject._internal(
      id: id,
      ...
      topics: topics == null ? this.topics : topics.value
    );
  }
  ...
  Subject.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _color = json['color'],
      _userID = json['userID'],
      _topics = json['topics']  is Map
        ? (json['topics']['items'] is List
          ? (json['topics']['items'] as List)
              .where((e) => e != null)
              .map((e) => Topic.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['topics'] is List
          ? (json['topics'] as List)
              .where((e) => e?['serializedData'] != null)
              .map((e) => Topic.fromJson(new Map<String, dynamic>.from(e?['serializedData'])))
              .toList()
          : null),
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'color': _color, 'userID': _userID, 'topics': _topics?.map((Topic? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final TOPICS = amplify_core.QueryField(
    fieldName: "topics",
    fieldType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.model, ofModelName: 'Topic'));
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ...
      amplify_core.ModelIndex(fields: const ["userID", "name"], name: "byUser")
    ];
